...
not_run: WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Username'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Password_Submit'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Logout'), FailureHandling.CONTINUE_ON_FAILURE)
